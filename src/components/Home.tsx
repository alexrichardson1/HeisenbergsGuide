  ...
  return (
    <Router>
      <div>
        ...
        <p className="info">
          If you have a first level lab, The Bathroom is an extremely safe spot
          as the Officers are not programmed to go into there, and In such only
          enter on extremely rare occasions; The only real way they go into the
          bathroom is if you lead them in there. If you store bags in the
          bathroom tub, Cops will <b>NOT</b> take them, or teleport them.
        </p>
        <p className="info">
        ...
        <p className="info">
          Having a dedicated cook that knows the lines is paramount. If it is
          just one person in the lobby, then have just one dedicated cook. It is
          better to take a slightly longer amount of time with just 1 cook, than
          have someone blow the lab. (If you see me in game, I am the designated
          cook. Only exception is if I am in custody.){" "}
        </p>
        <p className="info">
          ...
          before Bain says what to add, thereby speeding up the cook. (Once
          again, Only players who know the lines are to be cooks.)
        </p>
        <p className="info">
        ...
        <p className="info">
          The Helicopter can do 1 of 2 things; It can deploy a Bulldozer, or
          spawn Yellow SWAT on the balcony. If hovering behind the home, A
          Bulldozer will deploy from the Helicopter. If hovering above the home,
          it will spawn Yellow SWAT on the balcony.
        </p>
